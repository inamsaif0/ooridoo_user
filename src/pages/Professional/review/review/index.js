                ...
                <div className='container'>
                    <div className='row mt-3 mb-3' >
                        ...
                        <div className='col-lg-8  ' >
                            <h1 className="mt-3">No Reviews for Jin Floydh</h1>
                            <button type="button" class="btn btn-outline-secondary" onClick={()=>navigate("/professional/reviewrequest")}>Get Review</button>

                            <h6 className="mt-3">You do not have any reviews. Increase your visibility on Houzz by asking for reviews from your clients!</h6>
