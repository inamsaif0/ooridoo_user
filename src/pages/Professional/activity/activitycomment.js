                ...
                <div className='container'>
                    <div className='row mt-3 mb-3' >
                        ...
                        <div className='col-lg-8  ' >
                            <h1 className="mt-3">No Comments</h1>
                            <h6 className="mt-3">You haven’t commented on any posts..</h6>
                            <p className="mt-4" style={{cursor:"pointer" ,color:"#007562"}} >See what verified are working on and add your advice </p>
                        </div>
