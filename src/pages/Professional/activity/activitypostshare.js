...
const ProfessionalActivityPosts = () => {
                ...
                <div className='container'>
                    <div className='row mt-3 mb-3' >
                        ...
                        <div className='col-lg-8  ' >
                            <h1 className="mt-3">No Posts</h1>
                            <h6 className="mt-3">You haven’t started any posts. Ask a question of our design community or let your followers know what you’re up to!</h6>
                            <p className="mt-4" style={{cursor:"pointer" ,color:"#007562"}} >Ask the community</p>
                        </div>
                    </div>
...
export default ProfessionalActivityPosts;
