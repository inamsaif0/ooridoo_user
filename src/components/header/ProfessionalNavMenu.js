...
const ProfessionalNavMenu = ({ menuWhiteClass, sidebarMenu }) => {
    ...
    >
      <nav>
        <ul>
          ...
          <li>
            <Link to={process.env.PUBLIC_URL + "/professional/findProfessional"}>
              {" "}
            ...
            <ul className="mega-menu">
              <li>
                <ul>
                  <li className="mega-menu-title">
                    <Link to={process.env.PUBLIC_URL + "/professional/list"}>
                      {t("Popular")}
                    </Link>
                  </li>
                  <li>
                    <Link to={process.env.PUBLIC_URL + "/professional/list"}>
                      {t("Interior Designers & Decorators")}
                    </Link>
                  </li>
                  {/* <li>
