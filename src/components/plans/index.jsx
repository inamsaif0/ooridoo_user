        ...
        <table className="price-table">
            <tbody>
                <tr>
                    ...
                    <td className="price-blank" />
                    <td className="price-blank" />
                    <td className="price-table-popular">RECOMMENDED</td>
                    <td className="price-blank" />
                </tr>
                ...
                <tr>
                    <td>
                        <h3>Your design business, managed</h3>
                    </td>
                    <td className="price">
                        ...
                        <br />$0/month
                        <br /><p>&nbsp;</p>
                        <Link to="/professional-onBoarding">Get started</Link>
                    </td>
                    <td className="price">
                        <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 128 128">
                            <defs />
                        ...
                        <br />$0/month
                        <br /><p>30 day free trial, then $65/mo</p>
                        <Link to="/professional-onBoarding">Start Free Trail</Link>
                    </td>
                    <td className="price">
                        <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 128 128">
                            <defs />
                        ...
                        <br />$0/month
                        <br /><p>30 day free trial, then $99/mo</p>
                        <Link to="/professional-onBoarding">Start Free Trail</Link>
                    </td>
                    <td className="price">
                        <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 128 128">
                        ...
                        <br />$0/month
                        <br /><p>One advertising area, standard exposure</p>
                        <Link to="/professional-onBoarding">Contact Sales</Link>
                    </td>
                </tr>
                <tr>
                    <td><a href="#wordpress-asset-updates" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a><strong>PROJECT PLANNING</strong></td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    <td><a href="#wordpress-core-updates" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a> Mood Boards</td>
                    <td>30 Days</td>
                    <td>30 Days</td>
                    <td>90 Days</td>
                    <td>180 Days</td>
                ...
                <tr>
                    <td><a href="#wordpress-security-monitoring" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a> 3D Floor Planner</td>
                    <td><FaTimes /></td>
                    <td><FaCheck /></td>
                ...
                <tr>
                    <td><a href="#wordpress-uptime-monitoring" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a> Room Planner</td>
                ...
                <tr>
                    <td><a href="#wordpress-malware-cleanup" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a> Takeoffs</td>
                    <td><i className="fas fa-times" /></td>
                    <td><i className="fas fa-times" /></td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                ...
                <tr>
                    <td><a href="#wordpress-asset-updates" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a><strong>BUSINESS MANAGEMENT</strong></td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    <td><a href="#wordpress-security-audit" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a> Proposals</td>
                    <td><i className="fas fa-times" /></td>
                    <td><i className="fas fa-times" /></td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                ...
                <tr>
                    <td><a href="#wordpress-security-audit" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a> Invoicing</td>
                    <td><i className="fas fa-times" /></td>
                    <td><i className="fas fa-times" /></td>
                    <td><i className="fas fa-times" /></td>
                    <td><i className="fas fa-check" /></td>
                ...
                <tr>
                    <td><a href="#wordpress-priority-support" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a> Online Payments</td>
                    <td><i className="fas fa-times" /></td>
                    <td><i className="fas fa-times" /></td>
                    <td><i className="fas fa-times" /></td>
                    <td><i className="fas fa-check" /></td>
                ...
                <tr>
                    <td><a href="#wordpress-billing" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a> QuickBooks Integration</td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                ...
                {/* PROJECT MANAGEMENT */}
                <tr>
                    <td><a href="#wordpress-asset-updates" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a><strong>PROJECT MANAGEMENT</strong></td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    <td><a href="#wordpress-billing" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a> Project Tracker</td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                ...
                <tr>
                    <td><a href="#wordpress-billing" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a> Task Management</td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                ...
                <tr>
                    <td><a href="#wordpress-billing" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a> Project Timeline</td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                ...
                <tr>
                    <td><a href="#wordpress-billing" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a> Daily Logs</td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                ...
                <tr>
                    <td><a href="#wordpress-billing" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a> Time Tracking</td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                ...
                <tr>
                    <td><a href="#wordpress-billing" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a> Vendor Management</td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                ...
                <tr>
                    <td><a href="#wordpress-billing" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a> Purchase Orders</td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                ...
                <tr>
                    <td><a href="#wordpress-billing" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a> Expense Tracking</td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                    <td><FaCheck /></td>
                ...
                {/* MARKETING SOLUTIONS */}
                <tr>
                    <td><a href="#wordpress-asset-updates" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a><strong>MARKETING SOLUTIONS</strong></td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    <td><a href="#wordpress-billing" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a> Email Marketing</td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                    <td><FaCheck /></td>
                    <td><FaCheck /></td>
                ...
                <tr>
                    <td><a href="#wordpress-billing" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a> Premium Profile</td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                    <td><FaCheck /></td>
                    <td><FaCheck /></td>
                ...
                <tr>
                    <td><a href="#wordpress-billing" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a> PerfectCapture Photo Services</td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                    <td><FaCheck /></td>
                    <td><FaCheck /></td>
                ...
                <tr>
                    <td><a href="#wordpress-billing" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a> Custom Website</td>
                    <td><i className="" /></td>
                    <td><i className="" /></td>
                    <td><FaCheck /></td>
                    <td><FaCheck /></td>
                ...
                {/* GET MORE LEADS */}
                <tr>
                    <td><a href="#wordpress-asset-updates" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a><strong>GET MORE LEADS</strong></td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    <td><a href="#wordpress-billing" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a> Preferred Directory Placement</td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                ...
                <tr>
                    <td><a href="#wordpress-billing" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a> Lead Generation Program</td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                ...
                <tr>
                    <td><a href="#wordpress-billing" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a> Targeted Advertising</td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="fas fa-check" /></td>
                ...
                {/* TEAMS */}
                <tr>
                    <td><a href="#wordpress-asset-updates" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a><strong>TEAMS</strong></td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    <td><a href="#wordpress-billing" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a> Users</td>
                    <td><i className="" />1</td>
                    <td><i className="" />1</td>
                    <td><i className="" />1</td>
                    <td><i className="" />Unlimited</td>
                </tr>
                <tr>
                    <td><a href="#wordpress-billing" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a> Additional Users</td>
                    <td><i className="fas fa-check" /></td>
                    <td><i className="" />$40/user/mo</td>
                    <td><i className="" />$40/user/mo</td>
                    <td><i className="" />Unlimited</td>
                </tr>
                {/* SUPPORT */}
                <tr>
                    <td><a href="#wordpress-asset-updates" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a><strong>SUPPORT</strong></td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td></td>
                ...
                <tr>
                    <td><a href="#wordpress-billing" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a> Customer Support</td>
                    <td><i className="" /></td>
                    <td><i className="" />Email</td>
                    <td><i className="" />Phone</td>
                    <td><i className="" />Dedicated</td>
                </tr>
                <tr>
                    <td><a href="#wordpress-billing" className="price-table-help"><i className="far fa-fw fa-question-circle" /></a> Onboarding Experts</td>
                    <td><i className="" /></td>
                    <td><i className="" /><FaCheck /></td>
                    <td><i className="" /><FaCheck /></td>
                    <td><i className="" /><FaCheck /></td>
                </tr>
                <tr>
